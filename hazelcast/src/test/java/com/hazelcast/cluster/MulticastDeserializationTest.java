...
import com.hazelcast.nio.DeserializationChecker;
...
public class MulticastDeserializationTest {
    ...
    @Rule
    public final OverridePropertyRule ruleSysPropBlacklist = set(DeserializationChecker.PROPERTY_BLACKLIST, TestDeserialized.class.getName());
