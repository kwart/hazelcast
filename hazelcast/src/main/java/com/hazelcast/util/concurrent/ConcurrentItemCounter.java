...
public final class ConcurrentItemCounter<T> {
    ...
    public void set(T item, long value) {
        map.computeIfAbsent(item, k->new AtomicLong()).set(value);
    }
    ...
    public void add(T item, long delta) {
        map.computeIfAbsent(item, k->new AtomicLong()).addAndGet(delta);
    }
    ...
    public long getAndSet(T item, long value) {
        return map.computeIfAbsent(item, k->new AtomicLong()).getAndSet(value);
    }
