...
public final class AuditlogDiagnosticsWrapper implements AuditlogService {

    public static final AuditlogDiagnosticsWrapper INSTANCE = new AuditlogDiagnosticsWrapper();

    private final Builder builder = new Builder();

    private AuditlogDiagnosticsWrapper() {
    }
